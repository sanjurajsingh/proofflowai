...
GRANT SELECT ON public.submission_fingerprints TO authenticated;
GRANT ALL ON public.submission_fingerprints TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.disposable_email_domains TO authenticated;
...
-- 11) Storage: scoped proof policies
